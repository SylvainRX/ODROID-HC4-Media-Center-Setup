...
# Detect actual IP and meshnet hostname
HC4_IP=$(get_hc4_ip || echo "<HC4-IP>")
MESHNET_HOSTNAME=$(get_meshnet_hostname || echo "<meshnet-hostname>")

echo "==============================================="
echo "Access your services:"
echo "==============================================="
echo ""
echo "📡 Via NordVPN Meshnet (remote, non-local network):"
echo "  OpenMediaVault: http://${MESHNET_HOSTNAME}/omv"
echo "  Jellyfin:       http://${MESHNET_HOSTNAME}/jellyfin"
echo "  Sonarr:         http://${MESHNET_HOSTNAME}/sonarr"
echo "  Radarr:         http://${MESHNET_HOSTNAME}/radarr"
echo "  Prowlarr:       http://${MESHNET_HOSTNAME}/prowlarr"
echo "  Transmission:   http://${MESHNET_HOSTNAME}/transmission"
echo ""
echo "🏠 Via Local Network (reverse proxy, recommended):"
echo "  OpenMediaVault: http://${HC4_IP}/omv"
echo "  Jellyfin:       http://${HC4_IP}/jellyfin"
echo "  Sonarr:         http://${HC4_IP}/sonarr"
echo "  Radarr:         http://${HC4_IP}/radarr"
echo "  Prowlarr:       http://${HC4_IP}/prowlarr"
echo "  Transmission:   http://${HC4_IP}/transmission"
echo ""
echo "⚡ Via Direct Port Access (original ports, still available):"
echo "  OpenMediaVault: http://${HC4_IP}:8080"
echo "  Jellyfin:       http://${HC4_IP}:8096"
echo "  Sonarr:         http://${HC4_IP}:8989"
echo "  Radarr:         http://${HC4_IP}:7878"
echo "  Prowlarr:       http://${HC4_IP}:9696"
echo "  Transmission:   http://${HC4_IP}:9091"
echo ""
echo "==============================================="
echo "Remaining manual steps:"
echo "==============================================="
echo "  1. Add indexers in Prowlarr: http://${HC4_IP}:9696"
echo "  2. Create Jellyfin account: http://${HC4_IP}:8096"
